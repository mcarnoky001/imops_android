...
public class DeleteTicket extends AsyncTask<String, Integer, Boolean> {
	...
	public DeleteTicket(Context context) {
		mContext = context;
	}
	...
	public void select() {
		...
		try {
			...
			HttpPost httppost = new HttpPost("http://147.175.145.190/DeleteTicket.php");
