...
import com.capps.smartbus.Star;

public class getBenefitMenu extends AsyncTask<String, Integer, Float> {
	...
	public getBenefitMenu(Context context, Star obj) {
		mContext = context;
		this.obj = obj;
	}
