...
public class getTicketsDriver extends
		AsyncTask<String, Integer, List<Historia>> {
	...
	public getTicketsDriver(Context context, Listky_driver obj) {
		mContext = context;
		this.obj = obj;
	}
	...
	public void select() {
		...
		try {
			...
			HttpPost httppost = new HttpPost(
					"http://147.175.145.190/GetTicketsOfRides.php");
