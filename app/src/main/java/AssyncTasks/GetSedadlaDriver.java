...
public class GetSedadlaDriver extends AsyncTask<String, Integer, List<Integer>> {
	...
	public GetSedadlaDriver(Context context, Buy_driver obj) {
		mContext = context;
		this.obj = obj;
	}
	...
	public void select() {
		...
		try {
			...
			Log.e(" get sedadla driver pass 1", "connection success ");
		} catch (Exception e) {
			Log.e(" get sedadla driver Fail 1", e.toString());
		}
		...
		try {
			...
			Log.e(" get sedadla driver pass 2", "connection success ");
		} catch (Exception e) {
			Log.e(" cget sedadla driver Fail 2", e.toString());
		}
