...
import com.capps.smartbus.Sedadla64_driver;

public class GetSedadla_driver extends
	...
	boolean stav = false;
	List<Integer> cisla;
	Sedadla64_driver obj;

	private Context mContext;

	public GetSedadla_driver(Context context, Sedadla64_driver obj) {
		mContext = context;
		this.obj = obj;
	}
